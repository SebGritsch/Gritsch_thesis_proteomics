...
command <- str_glue("python $(wslpath -a {scripts_dir}/extract_sequences.py)",
                    "-i $(wslpath -a {protdb_dir}/2024-01-24-decoys-ec_3_AND_rev_nep_sar_ten_2023_10_16_contam.fasta.fas)",
...
```
```{r make blast db}
blastdb_dir <- here("data/blast")
# activate conda environment
conda <- "conda activate thesis"
# command to create blast database
command <- str_glue("makeblastdb",
                    "-in $(wslpath -a {blastdb_dir}/plastic_degraders.fasta)",
                    "-dbtype prot",
                    "-out $(wslpath -a {blastdb_dir}/blast_db)",
                    .sep = " ")
...
command <- str_glue("blastp",
                    ...
                    "-db $(wslpath -a {blastdb_dir}/blast_db)",
                    "-max_target_seqs 6",
                    "-outfmt 6",
